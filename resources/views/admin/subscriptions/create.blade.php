...
@section('title',__('views.subscription.subscription_add') )

@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            {{ Form::open(['route'=>['admin.subscriptions.store'],'method' => 'post','class'=>'form-horizontal form-label-left']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <input id="number" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('number')) parsley-error @endif"
                               name="number" value="{{ old('number') }}" required min="0" oninput="this.value = Math.abs(this.value)">
                       ...
                       <div class="col-md-3 col-sm-3 col-xs-12">
                           {!! Form::select("type", ["day"=>'Day',"week"=>'Week',"month"=>'Month',"year"=>'Year'], old('type'), ['class'=>"form-control col-md-7 col-xs-12","required"=>"required"]) !!}
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::textarea('description', old('description'), ['class'=>"form-control col-md-7 col-xs-12","required"=>"required"]) !!}
