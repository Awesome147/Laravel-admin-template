...
Route::match(['post','get'],'/profile', 'HomeController@isGetprofile');
Route::match(['post','get'],'/change-password', 'HomeController@isGetchangePassword');
Route::match(['post','get'],'/delete-account', 'HomeController@isGetAccountDeleteAccount');
Route::get('/demo', 'ChargebeeController@index');
Route::get('/subscription', 'HomeController@subscription');
Route::get('/subscription-pay/{id}', 'HomeController@subscriptionPay');
